...
//            ]
//        ]
//        AF.request(Config.baseURL+"articles/search", method: .post, parameters: parameters, encoding: JSONEncoding.default, interceptor: AuthenticationInterceptor(authenticator: OAuthAuthenticator(), credential: OAuthCredential(accessToken: UserDefaultsManager.shared.getTokens().accessToken ?? "", refreshToken: UserDefaultsManager.shared.getTokens().refreshToken ?? "")))
